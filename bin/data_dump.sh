...
mysqldump -u cs314-db -p -h faure cs314 country --lock-tables=false > ../server/src/test/resources/country.sql

mysqldump -u cs314-db -p -h faure cs314 region --lock-tables=false > ../server/src/test/resources/region.sql
